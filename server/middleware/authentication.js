...
const aboutMiddleWare = async function (req, res, next) {
  try {
    ...
    // console.log(verifyToken); jo token cookie ma save ha usko sath secret key ko match kry or pata chalai ga ka ya secret key iske cookie ke ha agr same hote ha to us cookie ka sath jitna ba data attach krwaya hoga apna like idd email etc sab mily ga
